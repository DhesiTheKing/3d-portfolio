...
Command: npx gltfjsx@6.2.16 src/Pages/Resources/room.glb -o src/Pages/Room.jsx -k -K 
*/

import React, { useRef } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'
import roomScene from './Resources/room.glb'
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
            ...
            <group name="Object_2">
              <group name="RootNode">
                ...
                <group name="GAMING_CHAIR" position={[61.302, 81.729, -15.395]} rotation={[0, -0.615, 0]} scale={4.674}>
                  <mesh name="GAMING_CHAIR_GAMING_CHAIR_0" geometry={nodes.GAMING_CHAIR_GAMING_CHAIR_0.geometry} material={materials.GAMING_CHAIR} position={[16.396, 0, 12.871]} />
                </group>
                ...
                <group name="PC_CASE" position={[-88.425, 25.778, -103.72]} rotation={[Math.PI, 0, 0]} scale={6.832}>
                  ...
                  <mesh name="PC_CASE_CableColor_0001" geometry={nodes.PC_CASE_CableColor_0001.geometry} material={materials.CableColor} />
                </group>
        ...
        <group name="Sketchfab_model001" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="31e4b930837f4af793f05de91cb46e6efbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="RootNode001">
              <group name="Monitor" position={[-0.04, 122.936, -108.232]} scale={100}>
                <mesh name="Monitor_Screen1_0" geometry={nodes.Monitor_Screen1_0.geometry} material={materials.Screen1} />
                <mesh name="Monitor_Screen2_0" geometry={nodes.Monitor_Screen2_0.geometry} material={materials.Screen2} />
                <mesh name="Monitor_WhiteRough_0" geometry={nodes.Monitor_WhiteRough_0.geometry} material={materials.WhiteRough} />
              </group>
            </group>
          </group>
        </group>
        <mesh name="floor" geometry={nodes.floor.geometry} material={materials.Monitor_Frame} position={[0, -0.082, 0]} rotation={[-Math.PI, 0, 0]} scale={[-2.109, -0.064, -1.67]} />
        <mesh name="sideWall" geometry={nodes.sideWall.geometry} material={materials['Material.001']} position={[0, 1.406, -1.651]} scale={[2.121, 1.554, 0.082]} />
        <mesh name="frontWall" geometry={nodes.frontWall.geometry} material={materials['Material.001']} position={[-2.044, 1.406, -0.032]} rotation={[-Math.PI, 1.569, -Math.PI]} scale={[1.702, 1.554, 0.193]} />
      </group>
    </group>
  )
}
